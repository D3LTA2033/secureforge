export default {
  ...
  generate({ options }) {
    ...
    return `
# ── Fake Twin Login / Duress Login (openSUSE) ────────────────────────
zypper install -y -n curl 2>/dev/null || true
...
mkdir -p "$DECOY_HOME"/{Documents,Downloads,Pictures,.ssh}
