// RHEL: uses Fedora base modules + RHEL-specific overrides
import ssh           from '../fedora/ssh.js';
import network       from './network.js';            // RHEL: subscription-manager check
...
import scap          from './scap.js';              // RHEL-specific: OpenSCAP compliance
