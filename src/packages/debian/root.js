export default {
  ...
  description: 'Lock root, sudo hardening, su restriction, wheel group enforcement',
  category: 'Access Control',
  defaultEnabled: true,

  options: [
    { id: 'lockRoot',       type: 'confirm', label: 'Lock root account?',                           default: true },
    { id: 'requireWheel',   type: 'confirm', label: 'Restrict sudo to sudo group only?',             default: true },
    ...
    { id: 'noSuNonSudo',    type: 'confirm', label: 'Block su for non-sudo users via PAM?',          default: true },
    { id: 'rootShell',      type: 'list',    label: 'Root shell:',                                   default: 'keep',
      choices: [
        { name: 'Keep current',               value: 'keep' },
        { name: '/usr/sbin/nologin',          value: '/usr/sbin/nologin' },
